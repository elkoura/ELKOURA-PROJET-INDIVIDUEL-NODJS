...
const validateBiere = [
  ...
  body("name")
    .notEmpty()
    .isString()
    .withMessage("Name doit etre un chaine de caractere"),
  body("description")
    .notEmpty()
    .isString()
    .withMessage("description doit etre un chaine de caractere"),
  body("degree")
    .notEmpty()
    .isFloat({ gt: 0 })
    .withMessage("degree doit etre positif"),
  body("prix")
    .notEmpty()
    .isFloat({ gt: 0 })
    .withMessage("prix doit etre positif"),
];
...
const updateValidateBiere = [
  ...
  body("degree")
    ...
    .isFloat({ min: 0 })
    .withMessage("Le degree doit être positif"),
  body("prix")
    .optional({ nullable: true })
    .isFloat({ min: 0 })
