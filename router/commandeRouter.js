...
router.post(
  ...
  [...createValidationRules, errorValidator],
  commandeController.store,
);
router.put(
  "/:id_commande",
  [...updateValidationRules, errorValidator],
  commandeController.update,
);
router.delete(
  "/:id_commande",
  [...validateCommandeIdParam, errorValidator],
...
router.get(
  "/details/:id_commande",
  [...validateCommandeIdParam, errorValidator],
  commandeController.pdf,
); //renvoie un pdf de la commande
